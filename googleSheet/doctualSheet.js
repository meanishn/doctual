...
var client_secret = path.dirname(require.main.filename) + "/googleSheet/client_secret.json";
...
module.exports = {
	getData : function (cb) {
		...
		fs.readFile(client_secret, function processClientSecrets(err, content) {
		  ...
		  // Google Sheets API.
		  self.authorize(JSON.parse(content), self.getSheet(cb));
		});
	},
		/**
	 ...
	 * https://docs.google.com/spreadsheets/d/1Qeu-oI5RZjoJ7dzYD8eVUOllAim7A-waZFs9NpQuHZw/edit#gid=77935241
	*/

	getSheet: function _getSheet(cb) {
